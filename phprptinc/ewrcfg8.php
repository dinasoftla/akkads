...
define("EWR_PROJECT_ID", "{F6306297-54D9-482A-802C-C71D7F2A088D}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "SISTEMAPEDIDOFACTURA5", TRUE); // Project Name
define("EWR_PROJECT_VAR", "SISTEMAPEDIDOFACTURA5", TRUE); // Project Var
...
define("EWR_DBMSNAME", 'Microsoft SQL Server', TRUE); // DBMS Name
define("EWR_IS_MSACCESS", FALSE, TRUE); // Access
define("EWR_IS_MSSQL", TRUE, TRUE); // SQL Server
define("EWR_IS_MYSQL", FALSE, TRUE); // MySQL
...
define("EWR_RANDOM_KEY", 'vzJ43tdH13QN5GMJ', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/SISTEMAPEDIDOFACTURA5.css", TRUE); // Project stylesheet file name
...
define("EWR_ADMIN_PASSWORD", "1234", TRUE);
...
define("EWR_QUARTER_SQL", "DATEPART(QUARTER,%s)", TRUE);
