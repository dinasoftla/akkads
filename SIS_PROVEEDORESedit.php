...
$SIS_PROVEEDORES_edit = NULL; // Initialize page object first

class cSIS_PROVEEDORES_edit extends cSIS_PROVEEDORES {
	...
	// Page object name
	var $PageObjName = 'SIS_PROVEEDORES_edit';
	...
	function Page_Main() {
		...
		if (@$_GET["codproveedor"] <> "") {
			$this->codproveedor->setQueryStringValue($_GET["codproveedor"]);
		}
		...
		// Check if valid key
		if ($this->codproveedor->CurrentValue == "")
			$this->Page_Terminate("SIS_PROVEEDORESlist.php"); // Invalid key, return to list
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("SIS_PROVEEDORESlist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$sReturnUrl = $this->getReturnUrl();
				if (ew_GetPageName($sReturnUrl) == "SIS_PROVEEDORESlist.php")
...
// Create page object
if (!isset($SIS_PROVEEDORES_edit)) $SIS_PROVEEDORES_edit = new cSIS_PROVEEDORES_edit();

// Page init
$SIS_PROVEEDORES_edit->Page_Init();

// Page main
$SIS_PROVEEDORES_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$SIS_PROVEEDORES_edit->Page_Render();
?>
...
var CurrentForm = fSIS_PROVEEDORESedit = new ew_Form("fSIS_PROVEEDORESedit", "edit");

// Validate form
fSIS_PROVEEDORESedit.Validate = function() {
...
fSIS_PROVEEDORESedit.Form_CustomValidate = 
...
fSIS_PROVEEDORESedit.ValidateRequired = true;
<?php } else { ?>
fSIS_PROVEEDORESedit.ValidateRequired = false; 
<?php } ?>
...
<?php $SIS_PROVEEDORES_edit->ShowPageHeader(); ?>
<?php
$SIS_PROVEEDORES_edit->ShowMessage();
?>
<form name="fSIS_PROVEEDORESedit" id="fSIS_PROVEEDORESedit" class="<?php echo $SIS_PROVEEDORES_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($SIS_PROVEEDORES_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $SIS_PROVEEDORES_edit->Token ?>">
<?php } ?>
...
<?php if ($SIS_PROVEEDORES->codproveedor->Visible) { // codproveedor ?>
	<div id="r_codproveedor" class="form-group">
		<label id="elh_SIS_PROVEEDORES_codproveedor" for="x_codproveedor" class="col-sm-2 control-label ewLabel"><?php echo $SIS_PROVEEDORES->codproveedor->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $SIS_PROVEEDORES->codproveedor->CellAttributes() ?>>
<span id="el_SIS_PROVEEDORES_codproveedor">
<span<?php echo $SIS_PROVEEDORES->codproveedor->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $SIS_PROVEEDORES->codproveedor->EditValue ?></p></span>
</span>
<input type="hidden" data-table="SIS_PROVEEDORES" data-field="x_codproveedor" name="x_codproveedor" id="x_codproveedor" value="<?php echo ew_HtmlEncode($SIS_PROVEEDORES->codproveedor->CurrentValue) ?>">
<?php echo $SIS_PROVEEDORES->codproveedor->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($SIS_PROVEEDORES->nombre->Visible) { // nombre ?>
	<div id="r_nombre" class="form-group">
		<label id="elh_SIS_PROVEEDORES_nombre" for="x_nombre" class="col-sm-2 control-label ewLabel"><?php echo $SIS_PROVEEDORES->nombre->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $SIS_PROVEEDORES->nombre->CellAttributes() ?>>
<span id="el_SIS_PROVEEDORES_nombre">
...
<?php echo $SIS_PROVEEDORES->nombre->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($SIS_PROVEEDORES->telefono->Visible) { // telefono ?>
	<div id="r_telefono" class="form-group">
		<label id="elh_SIS_PROVEEDORES_telefono" for="x_telefono" class="col-sm-2 control-label ewLabel"><?php echo $SIS_PROVEEDORES->telefono->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $SIS_PROVEEDORES->telefono->CellAttributes() ?>>
<span id="el_SIS_PROVEEDORES_telefono">
...
<?php echo $SIS_PROVEEDORES->telefono->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($SIS_PROVEEDORES->ciudad->Visible) { // ciudad ?>
	<div id="r_ciudad" class="form-group">
		<label id="elh_SIS_PROVEEDORES_ciudad" for="x_ciudad" class="col-sm-2 control-label ewLabel"><?php echo $SIS_PROVEEDORES->ciudad->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $SIS_PROVEEDORES->ciudad->CellAttributes() ?>>
<span id="el_SIS_PROVEEDORES_ciudad">
...
<?php echo $SIS_PROVEEDORES->ciudad->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($SIS_PROVEEDORES->direccion->Visible) { // direccion ?>
	<div id="r_direccion" class="form-group">
		<label id="elh_SIS_PROVEEDORES_direccion" for="x_direccion" class="col-sm-2 control-label ewLabel"><?php echo $SIS_PROVEEDORES->direccion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $SIS_PROVEEDORES->direccion->CellAttributes() ?>>
<span id="el_SIS_PROVEEDORES_direccion">
...
<?php echo $SIS_PROVEEDORES->direccion->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $SIS_PROVEEDORES_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fSIS_PROVEEDORESedit.Init();
</script>
<?php
$SIS_PROVEEDORES_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$SIS_PROVEEDORES_edit->Page_Terminate();
?>
