...
$SIS_CUENTAS_BANCARIAS_add = NULL; // Initialize page object first

class cSIS_CUENTAS_BANCARIAS_add extends cSIS_CUENTAS_BANCARIAS {
	...
	// Page object name
	var $PageObjName = 'SIS_CUENTAS_BANCARIAS_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "SIS_CUENTAS_BANCARIASview.php")
...
// Create page object
if (!isset($SIS_CUENTAS_BANCARIAS_add)) $SIS_CUENTAS_BANCARIAS_add = new cSIS_CUENTAS_BANCARIAS_add();

// Page init
$SIS_CUENTAS_BANCARIAS_add->Page_Init();

// Page main
$SIS_CUENTAS_BANCARIAS_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$SIS_CUENTAS_BANCARIAS_add->Page_Render();
?>
...
var CurrentForm = fSIS_CUENTAS_BANCARIASadd = new ew_Form("fSIS_CUENTAS_BANCARIASadd", "add");

// Validate form
fSIS_CUENTAS_BANCARIASadd.Validate = function() {
...
fSIS_CUENTAS_BANCARIASadd.Form_CustomValidate = 
...
fSIS_CUENTAS_BANCARIASadd.ValidateRequired = true;
<?php } else { ?>
fSIS_CUENTAS_BANCARIASadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fSIS_CUENTAS_BANCARIASadd.Lists["x_tipocuenta"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fSIS_CUENTAS_BANCARIASadd.Lists["x_tipocuenta"].Options = <?php echo json_encode($SIS_CUENTAS_BANCARIAS->tipocuenta->Options()) ?>;
fSIS_CUENTAS_BANCARIASadd.Lists["x_moneda"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fSIS_CUENTAS_BANCARIASadd.Lists["x_moneda"].Options = <?php echo json_encode($SIS_CUENTAS_BANCARIAS->moneda->Options()) ?>;
...
<?php $SIS_CUENTAS_BANCARIAS_add->ShowPageHeader(); ?>
<?php
$SIS_CUENTAS_BANCARIAS_add->ShowMessage();
?>
<form name="fSIS_CUENTAS_BANCARIASadd" id="fSIS_CUENTAS_BANCARIASadd" class="<?php echo $SIS_CUENTAS_BANCARIAS_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($SIS_CUENTAS_BANCARIAS_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $SIS_CUENTAS_BANCARIAS_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $SIS_CUENTAS_BANCARIAS_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fSIS_CUENTAS_BANCARIASadd.Init();
</script>
<?php
$SIS_CUENTAS_BANCARIAS_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$SIS_CUENTAS_BANCARIAS_add->Page_Terminate();
?>
