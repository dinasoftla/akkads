...
$SIS_PEDIDO_ACTUAL = NULL;

//
// Table class for SIS_PEDIDO_ACTUAL
//
class cSIS_PEDIDO_ACTUAL extends cTable {
	var $codusuario;
	var $codarticulo;
	var $cantidad;
	...
	function __construct() {
		...
		$this->TableVar = 'SIS_PEDIDO_ACTUAL';
		$this->TableName = 'SIS_PEDIDO_ACTUAL';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "[dbo].[SIS_PEDIDO_ACTUAL]";
		$this->DBID = 'DB';
		...
		// codusuario
		$this->codusuario = new cField('SIS_PEDIDO_ACTUAL', 'SIS_PEDIDO_ACTUAL', 'x_codusuario', 'codusuario', '[codusuario]', 'CAST([codusuario] AS NVARCHAR)', 3, -1, FALSE, '[codusuario]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->codusuario->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['codusuario'] = &$this->codusuario;

		// codarticulo
		$this->codarticulo = new cField('SIS_PEDIDO_ACTUAL', 'SIS_PEDIDO_ACTUAL', 'x_codarticulo', 'codarticulo', '[codarticulo]', '[codarticulo]', 200, -1, FALSE, '[codarticulo]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['codarticulo'] = &$this->codarticulo;

		// cantidad
		$this->cantidad = new cField('SIS_PEDIDO_ACTUAL', 'SIS_PEDIDO_ACTUAL', 'x_cantidad', 'cantidad', '[cantidad]', 'CAST([cantidad] AS NVARCHAR)', 3, -1, FALSE, '[cantidad]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "[dbo].[SIS_PEDIDO_ACTUAL]";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "SIS_PEDIDO_ACTUALlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("SIS_PEDIDO_ACTUALview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("SIS_PEDIDO_ACTUALview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "SIS_PEDIDO_ACTUALadd.php?" . $this->UrlParm($parm);
		else
			$url = "SIS_PEDIDO_ACTUALadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("SIS_PEDIDO_ACTUALedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("SIS_PEDIDO_ACTUALadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("SIS_PEDIDO_ACTUALdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->codusuario->PlaceHolder = ew_RemoveHtml($this->codusuario->FldCaption());
