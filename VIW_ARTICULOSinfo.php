...
//
// Table class for VIW_ARTICULOS
//
class cVIW_ARTICULOS extends cTable {
	var $codarticulo;
	var $descripcion;
	var $precio;
	var $caracteristicas;
	...
	function __construct() {
		...
		$this->TableVar = 'VIW_ARTICULOS';
		$this->TableName = 'VIW_ARTICULOS';
		$this->TableType = 'VIEW';
		...
		// codarticulo
		$this->codarticulo = new cField('VIW_ARTICULOS', 'VIW_ARTICULOS', 'x_codarticulo', 'codarticulo', '[codarticulo]', '[codarticulo]', 200, -1, FALSE, '[codarticulo]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['codarticulo'] = &$this->codarticulo;

		// descripcion
		$this->descripcion = new cField('VIW_ARTICULOS', 'VIW_ARTICULOS', 'x_descripcion', 'descripcion', '[descripcion]', '[descripcion]', 200, -1, FALSE, '[descripcion]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['descripcion'] = &$this->descripcion;

		// precio
		$this->precio = new cField('VIW_ARTICULOS', 'VIW_ARTICULOS', 'x_precio', 'precio', '[precio]', 'CAST([precio] AS NVARCHAR)', 131, -1, FALSE, '[precio]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->precio->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['precio'] = &$this->precio;

		// caracteristicas
		$this->caracteristicas = new cField('VIW_ARTICULOS', 'VIW_ARTICULOS', 'x_caracteristicas', 'caracteristicas', '[caracteristicas]', '[caracteristicas]', 200, -1, FALSE, '[caracteristicas]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['caracteristicas'] = &$this->caracteristicas;

		// referencia
		$this->referencia = new cField('VIW_ARTICULOS', 'VIW_ARTICULOS', 'x_referencia', 'referencia', '[referencia]', '[referencia]', 200, -1, FALSE, '[referencia]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['referencia'] = &$this->referencia;

		// garantia
		$this->garantia = new cField('VIW_ARTICULOS', 'VIW_ARTICULOS', 'x_garantia', 'garantia', '[garantia]', '[garantia]', 200, -1, FALSE, '[garantia]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "[VIW_ARTICULOS]";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("VIW_ARTICULOSview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("VIW_ARTICULOSview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "VIW_ARTICULOSadd.php?" . $this->UrlParm($parm);
		else
			$url = "VIW_ARTICULOSadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("VIW_ARTICULOSedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("VIW_ARTICULOSadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("VIW_ARTICULOSdelete.php", $this->UrlParm());
	}
