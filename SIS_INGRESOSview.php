...
$SIS_INGRESOS_view = NULL; // Initialize page object first

class cSIS_INGRESOS_view extends cSIS_INGRESOS {
	...
	// Page object name
	var $PageObjName = 'SIS_INGRESOS_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["consecutivo"] <> "") {
				...
				$sReturnUrl = "SIS_INGRESOSlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "SIS_INGRESOSlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "SIS_INGRESOSlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_SIS_INGRESOS\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_SIS_INGRESOS',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fSIS_INGRESOSview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($SIS_INGRESOS_view)) $SIS_INGRESOS_view = new cSIS_INGRESOS_view();

// Page init
$SIS_INGRESOS_view->Page_Init();

// Page main
$SIS_INGRESOS_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$SIS_INGRESOS_view->Page_Render();
?>
<?php include_once "header.php" ?>
<?php if ($SIS_INGRESOS->Export == "") { ?>
<script type="text/javascript">

// Form object
var CurrentPageID = EW_PAGE_ID = "view";
var CurrentForm = fSIS_INGRESOSview = new ew_Form("fSIS_INGRESOSview", "view");

// Form_CustomValidate event
fSIS_INGRESOSview.Form_CustomValidate = 
...
fSIS_INGRESOSview.ValidateRequired = true;
<?php } else { ?>
fSIS_INGRESOSview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fSIS_INGRESOSview.Lists["x_tipo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fSIS_INGRESOSview.Lists["x_tipo"].Options = <?php echo json_encode($SIS_INGRESOS->tipo->Options()) ?>;
fSIS_INGRESOSview.Lists["x_codcliente"] = {"LinkField":"x_codcliente","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php } ?>
<?php $SIS_INGRESOS_view->ExportOptions->Render("body") ?>
<?php
	foreach ($SIS_INGRESOS_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($SIS_INGRESOS->Export == "") { ?>
...
<?php } ?>
<?php $SIS_INGRESOS_view->ShowPageHeader(); ?>
<?php
$SIS_INGRESOS_view->ShowMessage();
?>
<form name="fSIS_INGRESOSview" id="fSIS_INGRESOSview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($SIS_INGRESOS_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $SIS_INGRESOS_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="SIS_INGRESOS">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($SIS_INGRESOS->consecutivo->Visible) { // consecutivo ?>
	<tr id="r_consecutivo">
		<td><span id="elh_SIS_INGRESOS_consecutivo"><?php echo $SIS_INGRESOS->consecutivo->FldCaption() ?></span></td>
...
<?php echo $SIS_INGRESOS->consecutivo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_INGRESOS->fecha->Visible) { // fecha ?>
	<tr id="r_fecha">
		<td><span id="elh_SIS_INGRESOS_fecha"><?php echo $SIS_INGRESOS->fecha->FldCaption() ?></span></td>
		<td data-name="fecha"<?php echo $SIS_INGRESOS->fecha->CellAttributes() ?>>
<span id="el_SIS_INGRESOS_fecha">
<span<?php echo $SIS_INGRESOS->fecha->ViewAttributes() ?>>
<?php echo $SIS_INGRESOS->fecha->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_INGRESOS->tipo->Visible) { // tipo ?>
	<tr id="r_tipo">
		<td><span id="elh_SIS_INGRESOS_tipo"><?php echo $SIS_INGRESOS->tipo->FldCaption() ?></span></td>
...
<?php echo $SIS_INGRESOS->tipo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_INGRESOS->codcliente->Visible) { // codcliente ?>
	<tr id="r_codcliente">
		<td><span id="elh_SIS_INGRESOS_codcliente"><?php echo $SIS_INGRESOS->codcliente->FldCaption() ?></span></td>
...
<?php echo $SIS_INGRESOS->codcliente->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_INGRESOS->factura->Visible) { // factura ?>
	<tr id="r_factura">
		<td><span id="elh_SIS_INGRESOS_factura"><?php echo $SIS_INGRESOS->factura->FldCaption() ?></span></td>
...
<?php echo $SIS_INGRESOS->factura->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_INGRESOS->descripcion->Visible) { // descripcion ?>
	<tr id="r_descripcion">
		<td><span id="elh_SIS_INGRESOS_descripcion"><?php echo $SIS_INGRESOS->descripcion->FldCaption() ?></span></td>
...
<?php echo $SIS_INGRESOS->descripcion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_INGRESOS->monto->Visible) { // monto ?>
	<tr id="r_monto">
		<td><span id="elh_SIS_INGRESOS_monto"><?php echo $SIS_INGRESOS->monto->FldCaption() ?></span></td>
...
<?php echo $SIS_INGRESOS->monto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($SIS_INGRESOS->Export == "") { ?>
<script type="text/javascript">
fSIS_INGRESOSview.Init();
</script>
<?php } ?>
<?php
$SIS_INGRESOS_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($SIS_INGRESOS->Export == "") { ?>
...
<?php
$SIS_INGRESOS_view->Page_Terminate();
?>
