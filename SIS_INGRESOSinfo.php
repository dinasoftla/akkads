...
//
// Table class for SIS_INGRESOS
//
class cSIS_INGRESOS extends cTable {
	var $consecutivo;
	var $fecha;
	var $tipo;
	var $codcliente;
	...
	function __construct() {
		...
		$this->TableVar = 'SIS_INGRESOS';
		$this->TableName = 'SIS_INGRESOS';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "[dbo].[SIS_INGRESOS]";
		$this->DBID = 'DB';
		...
		// consecutivo
		$this->consecutivo = new cField('SIS_INGRESOS', 'SIS_INGRESOS', 'x_consecutivo', 'consecutivo', '[consecutivo]', 'CAST([consecutivo] AS NVARCHAR)', 3, -1, FALSE, '[consecutivo]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->consecutivo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['consecutivo'] = &$this->consecutivo;

		// fecha
		$this->fecha = new cField('SIS_INGRESOS', 'SIS_INGRESOS', 'x_fecha', 'fecha', '[fecha]', '[fecha]', 202, -1, FALSE, '[fecha]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['fecha'] = &$this->fecha;

		// tipo
		$this->tipo = new cField('SIS_INGRESOS', 'SIS_INGRESOS', 'x_tipo', 'tipo', '[tipo]', '[tipo]', 200, -1, FALSE, '[tipo]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->tipo->OptionCount = 2;
		$this->fields['tipo'] = &$this->tipo;

		// codcliente
		$this->codcliente = new cField('SIS_INGRESOS', 'SIS_INGRESOS', 'x_codcliente', 'codcliente', '[codcliente]', 'CAST([codcliente] AS NVARCHAR)', 3, -1, FALSE, '[codcliente]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->codcliente->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['codcliente'] = &$this->codcliente;

		// factura
		$this->factura = new cField('SIS_INGRESOS', 'SIS_INGRESOS', 'x_factura', 'factura', '[factura]', 'CAST([factura] AS NVARCHAR)', 3, -1, FALSE, '[factura]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->factura->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['factura'] = &$this->factura;

		// descripcion
		$this->descripcion = new cField('SIS_INGRESOS', 'SIS_INGRESOS', 'x_descripcion', 'descripcion', '[descripcion]', '[descripcion]', 200, -1, FALSE, '[descripcion]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['descripcion'] = &$this->descripcion;

		// monto
		$this->monto = new cField('SIS_INGRESOS', 'SIS_INGRESOS', 'x_monto', 'monto', '[monto]', 'CAST([monto] AS NVARCHAR)', 5, -1, FALSE, '[monto]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "[dbo].[SIS_INGRESOS]";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("SIS_INGRESOSview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("SIS_INGRESOSview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "SIS_INGRESOSadd.php?" . $this->UrlParm($parm);
		else
			$url = "SIS_INGRESOSadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("SIS_INGRESOSedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("SIS_INGRESOSadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("SIS_INGRESOSdelete.php", $this->UrlParm());
	}
