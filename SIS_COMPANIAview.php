...
$SIS_COMPANIA_view = NULL; // Initialize page object first

class cSIS_COMPANIA_view extends cSIS_COMPANIA {
	...
	// Page object name
	var $PageObjName = 'SIS_COMPANIA_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["codcompania"] <> "") {
			$this->RecKey["codcompania"] = $_GET["codcompania"];
			$KeyUrl .= "&amp;codcompania=" . urlencode($this->RecKey["codcompania"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["codcompania"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["codcompania"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["codcompania"] <> "") {
				...
				$this->RecKey["codcompania"] = $this->codcompania->QueryStringValue;
			} elseif (@$_POST["codcompania"] <> "") {
				$this->codcompania->setFormValue($_POST["codcompania"]);
				$this->RecKey["codcompania"] = $this->codcompania->FormValue;
			} else {
				$sReturnUrl = "SIS_COMPANIAlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "SIS_COMPANIAlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "SIS_COMPANIAlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_SIS_COMPANIA\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_SIS_COMPANIA',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fSIS_COMPANIAview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($SIS_COMPANIA_view)) $SIS_COMPANIA_view = new cSIS_COMPANIA_view();

// Page init
$SIS_COMPANIA_view->Page_Init();

// Page main
$SIS_COMPANIA_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$SIS_COMPANIA_view->Page_Render();
?>
<?php include_once "header.php" ?>
<?php if ($SIS_COMPANIA->Export == "") { ?>
<script type="text/javascript">

// Form object
var CurrentPageID = EW_PAGE_ID = "view";
var CurrentForm = fSIS_COMPANIAview = new ew_Form("fSIS_COMPANIAview", "view");

// Form_CustomValidate event
fSIS_COMPANIAview.Form_CustomValidate = 
...
fSIS_COMPANIAview.ValidateRequired = true;
<?php } else { ?>
fSIS_COMPANIAview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fSIS_COMPANIAview.Lists["x_trasnporteenfactura"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fSIS_COMPANIAview.Lists["x_trasnporteenfactura"].Options = <?php echo json_encode($SIS_COMPANIA->trasnporteenfactura->Options()) ?>;
...
<?php } ?>
<?php $SIS_COMPANIA_view->ExportOptions->Render("body") ?>
<?php
	foreach ($SIS_COMPANIA_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($SIS_COMPANIA->Export == "") { ?>
...
<?php } ?>
<?php $SIS_COMPANIA_view->ShowPageHeader(); ?>
<?php
$SIS_COMPANIA_view->ShowMessage();
?>
<form name="fSIS_COMPANIAview" id="fSIS_COMPANIAview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($SIS_COMPANIA_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $SIS_COMPANIA_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="SIS_COMPANIA">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($SIS_COMPANIA->codcompania->Visible) { // codcompania ?>
	<tr id="r_codcompania">
		<td><span id="elh_SIS_COMPANIA_codcompania"><?php echo $SIS_COMPANIA->codcompania->FldCaption() ?></span></td>
...
<?php echo $SIS_COMPANIA->codcompania->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_COMPANIA->nombre->Visible) { // nombre ?>
	<tr id="r_nombre">
		<td><span id="elh_SIS_COMPANIA_nombre"><?php echo $SIS_COMPANIA->nombre->FldCaption() ?></span></td>
...
<?php echo $SIS_COMPANIA->nombre->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_COMPANIA->telefono->Visible) { // telefono ?>
	<tr id="r_telefono">
		<td><span id="elh_SIS_COMPANIA_telefono"><?php echo $SIS_COMPANIA->telefono->FldCaption() ?></span></td>
...
<?php echo $SIS_COMPANIA->telefono->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_COMPANIA->direccion->Visible) { // direccion ?>
	<tr id="r_direccion">
		<td><span id="elh_SIS_COMPANIA_direccion"><?php echo $SIS_COMPANIA->direccion->FldCaption() ?></span></td>
...
<?php echo $SIS_COMPANIA->direccion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_COMPANIA->descuento->Visible) { // descuento ?>
	<tr id="r_descuento">
		<td><span id="elh_SIS_COMPANIA_descuento"><?php echo $SIS_COMPANIA->descuento->FldCaption() ?></span></td>
...
<?php echo $SIS_COMPANIA->descuento->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_COMPANIA->piefactura->Visible) { // piefactura ?>
	<tr id="r_piefactura">
		<td><span id="elh_SIS_COMPANIA_piefactura"><?php echo $SIS_COMPANIA->piefactura->FldCaption() ?></span></td>
...
<?php echo $SIS_COMPANIA->piefactura->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_COMPANIA->leyendafactura->Visible) { // leyendafactura ?>
	<tr id="r_leyendafactura">
		<td><span id="elh_SIS_COMPANIA_leyendafactura"><?php echo $SIS_COMPANIA->leyendafactura->FldCaption() ?></span></td>
...
<?php echo $SIS_COMPANIA->leyendafactura->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_COMPANIA->trasnporteenfactura->Visible) { // trasnporteenfactura ?>
	<tr id="r_trasnporteenfactura">
		<td><span id="elh_SIS_COMPANIA_trasnporteenfactura"><?php echo $SIS_COMPANIA->trasnporteenfactura->FldCaption() ?></span></td>
...
<?php echo $SIS_COMPANIA->trasnporteenfactura->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($SIS_COMPANIA->Export == "") { ?>
<script type="text/javascript">
fSIS_COMPANIAview.Init();
</script>
<?php } ?>
<?php
$SIS_COMPANIA_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($SIS_COMPANIA->Export == "") { ?>
...
<?php
$SIS_COMPANIA_view->Page_Terminate();
?>
