...
// Set up chart
//$Chart = &$Table->HISTORIAL_DE_ARTICULOS;
// Initialize chart data

$Chart->ID = "VIW_HISTORIAL_ARTICULOS_HISTORIAL_DE_ARTICULOS"; // Chart ID
$Chart->SetChartParms(array(array("type", "11", FALSE),
...
$Chart->Trends[] = array(0, 0, "FF69B4", "", 1, "0", "1", 100, "", "0", "0", 0, 0, "");
?>
<?php
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_VIW_HISTORIAL_ARTICULOS_HISTORIAL_DE_ARTICULOS", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_VIW_HISTORIAL_ARTICULOS_HISTORIAL_DE_ARTICULOS_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
