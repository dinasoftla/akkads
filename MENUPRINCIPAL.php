...
$MENUPRINCIPAL_php = NULL; // Initialize page object first

class cMENUPRINCIPAL_php {
	...
	// Table name
	var $TableName = 'MENUPRINCIPAL.php';

	// Page object name
	var $PageObjName = 'MENUPRINCIPAL_php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'MENUPRINCIPAL.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "MENUPRINCIPAL_php", $url, "", "MENUPRINCIPAL_php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($MENUPRINCIPAL_php)) $MENUPRINCIPAL_php = new cMENUPRINCIPAL_php();

// Page init
$MENUPRINCIPAL_php->Page_Init();

// Page main
$MENUPRINCIPAL_php->Page_Main();
	...
	<table width="600" border="0" align="center">
		 <tr>
			...
			<ul id="demo_ul" style="z-index:10;font-size:10px;">
				<li class="demo_li"><a href="SIS_CUENTAS_BANCARIASlist.php">
					<div>
				       <br><i><img src="phpimages/bank.png"> </i>
					   <P><b><font color="black">CUENTAS BANCARIAS</font></b>
					</div>
				</li>
				<li class="demo_li"><a href="SIS_USUARIOSlist.php">
					<div>
				       <br><i><img src="phpimages/users.png"> </i>
					   <P><b><font color="black">USUARIOS</font></b>
					</div>
				</li>
				<li class="demo_li"><a href="SIS_COMPANIAlist.php">
					<div>
				       <br><i><img src="phpimages/home.png"> </i>
					   <P><b><font color="black">COMPAÑIA</font></b>
					</div>
				</li>
				<li class="demo_li"><a href="SIS_LINEAlist.php">
					<div>
				       <br><i><img src="phpimages/trending-neutral.png"> </i>
					   <P><b><font color="black">LINEA</font></b>
					</div>
				</li>
				<li class="demo_li"><a href="SIS_ARTICULOlist.php">
					<div>
				       <br><i><img src="phpimages/articulom.png"> </i>
					   <P><b><font color="black">ARTICULO</font></b>
					</div>
				</li>
				<li class="demo_li"><a href="SIS_UBICACIONESlist.php">
					<div>
				       <br><i><img src="phpimages/crosshairs-gps.png"> </i>
					   <P><b><font color="black">UBICACIONES</font></b>
					</div>
				</li>
				<li class="demo_li"><a href="SIS_CLIENTElist.php">
					<div>
				       <br><i><img src="phpimages/emoticon-happy.png"> </i>
					   <P><b><font color="black">CLIENTES</font></b>
					</div>
				</li>
				<li class="demo_li"><a href="SIS_PROVEEDORESlist.php">
					<div>
				       <br><i><img src="phpimages/proveedores.png"> </i>
					   <P><b><font color="black">PROVEEDORES</font></b>
					</div>
				</li>
				<li class="demo_li"><a href="SIS_JUSTIFICACIONESlist.php">
					<div>
				       <br><i><img src="phpimages/justificaciones.png"> </i>
					   <P><b><font color="black">JUSTIFICACIONES</font></b>
					</div>
				</li>
				<li class="demo_li"><a href="SIS_ETIQUETASlist.php">
					<div>
				       <br><i><img src="phpimages/etiquetas.png"> </i>
					   <P><b><font color="black">ETIQUETAS</font></b>
					</div>
				</li>
			</ul>
		</div>
...
<?php
$MENUPRINCIPAL_php->Page_Terminate();
?>
