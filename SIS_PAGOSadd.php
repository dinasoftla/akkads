...
$SIS_PAGOS_add = NULL; // Initialize page object first

class cSIS_PAGOS_add extends cSIS_PAGOS {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "SIS_PAGOSview.php")
...
// Create page object
if (!isset($SIS_PAGOS_add)) $SIS_PAGOS_add = new cSIS_PAGOS_add();

// Page init
$SIS_PAGOS_add->Page_Init();

// Page main
$SIS_PAGOS_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$SIS_PAGOS_add->Page_Render();
?>
...
var CurrentForm = fSIS_PAGOSadd = new ew_Form("fSIS_PAGOSadd", "add");

// Validate form
fSIS_PAGOSadd.Validate = function() {
...
fSIS_PAGOSadd.Form_CustomValidate = 
...
fSIS_PAGOSadd.ValidateRequired = true;
<?php } else { ?>
fSIS_PAGOSadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fSIS_PAGOSadd.Lists["x_tipo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fSIS_PAGOSadd.Lists["x_tipo"].Options = <?php echo json_encode($SIS_PAGOS->tipo->Options()) ?>;
fSIS_PAGOSadd.Lists["x_codproveedor"] = {"LinkField":"x_codproveedor","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $SIS_PAGOS_add->ShowPageHeader(); ?>
<?php
$SIS_PAGOS_add->ShowMessage();
?>
<form name="fSIS_PAGOSadd" id="fSIS_PAGOSadd" class="<?php echo $SIS_PAGOS_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($SIS_PAGOS_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $SIS_PAGOS_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $SIS_PAGOS_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
