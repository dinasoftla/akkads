...
define("EW_PROJECT_NAME", "SISTEMAPEDIDOFACTURA5", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{583510BF-00E0-41A1-A4E7-AF2AC6016C3C}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'T9zpH34nbLxRY9rU', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/SISTEMAPEDIDOFACTURA5.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MSSQL", "connectionstring" => "Provider=SQLOLEDB;Persist Security Info=False;Data Source=DESKTOP-FN7FSTU\\SQLEXPRESS;Initial Catalog=SISTEMA;User Id=sa;Password=Sistema1032", "qs" => "[", "qe" => "]");
...
define("EW_USER_TABLE", "[dbo].[SIS_USUARIOS]", TRUE);
