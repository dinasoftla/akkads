...
$SIS_FACTURA_DETALLE_view = NULL; // Initialize page object first

class cSIS_FACTURA_DETALLE_view extends cSIS_FACTURA_DETALLE {
	...
	// Page object name
	var $PageObjName = 'SIS_FACTURA_DETALLE_view';
	...
	function __construct() {
		...
		if (@$_GET["numdetfactura"] <> "") {
			$this->RecKey["numdetfactura"] = $_GET["numdetfactura"];
			$KeyUrl .= "&amp;numdetfactura=" . urlencode($this->RecKey["numdetfactura"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["numdetfactura"] <> "") {
			if ($gsExportFile <> "") $gsExportFile .= "_";
			$gsExportFile .= ew_StripSlashes($_GET["numdetfactura"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["numfactura"] <> "") {
				...
				$sReturnUrl = "SIS_FACTURA_DETALLElist.php"; // Return to list
			}
			if (@$_GET["numdetfactura"] <> "") {
				$this->numdetfactura->setQueryStringValue($_GET["numdetfactura"]);
				$this->RecKey["numdetfactura"] = $this->numdetfactura->QueryStringValue;
			} elseif (@$_POST["numdetfactura"] <> "") {
				$this->numdetfactura->setFormValue($_POST["numdetfactura"]);
				$this->RecKey["numdetfactura"] = $this->numdetfactura->FormValue;
			} else {
				$sReturnUrl = "SIS_FACTURA_DETALLElist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "SIS_FACTURA_DETALLElist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "SIS_FACTURA_DETALLElist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_SIS_FACTURA_DETALLE\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_SIS_FACTURA_DETALLE',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fSIS_FACTURA_DETALLEview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($SIS_FACTURA_DETALLE_view)) $SIS_FACTURA_DETALLE_view = new cSIS_FACTURA_DETALLE_view();

// Page init
$SIS_FACTURA_DETALLE_view->Page_Init();

// Page main
$SIS_FACTURA_DETALLE_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$SIS_FACTURA_DETALLE_view->Page_Render();
?>
...
var CurrentForm = fSIS_FACTURA_DETALLEview = new ew_Form("fSIS_FACTURA_DETALLEview", "view");

// Form_CustomValidate event
fSIS_FACTURA_DETALLEview.Form_CustomValidate = 
...
fSIS_FACTURA_DETALLEview.ValidateRequired = true;
<?php } else { ?>
fSIS_FACTURA_DETALLEview.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $SIS_FACTURA_DETALLE_view->ExportOptions->Render("body") ?>
<?php
	foreach ($SIS_FACTURA_DETALLE_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($SIS_FACTURA_DETALLE->Export == "") { ?>
...
<?php } ?>
<?php $SIS_FACTURA_DETALLE_view->ShowPageHeader(); ?>
<?php
$SIS_FACTURA_DETALLE_view->ShowMessage();
?>
<form name="fSIS_FACTURA_DETALLEview" id="fSIS_FACTURA_DETALLEview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($SIS_FACTURA_DETALLE_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $SIS_FACTURA_DETALLE_view->Token ?>">
<?php } ?>
...
<?php if ($SIS_FACTURA_DETALLE->Export == "") { ?>
<script type="text/javascript">
fSIS_FACTURA_DETALLEview.Init();
</script>
<?php } ?>
<?php
$SIS_FACTURA_DETALLE_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($SIS_FACTURA_DETALLE->Export == "") { ?>
...
<?php
$SIS_FACTURA_DETALLE_view->Page_Terminate();
?>
