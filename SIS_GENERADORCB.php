...
$SIS_GENERADORCB_php = NULL; // Initialize page object first

class cSIS_GENERADORCB_php {
	...
	// Table name
	var $TableName = 'SIS_GENERADORCB.php';

	// Page object name
	var $PageObjName = 'SIS_GENERADORCB_php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'SIS_GENERADORCB.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "SIS_GENERADORCB_php", $url, "", "SIS_GENERADORCB_php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($SIS_GENERADORCB_php)) $SIS_GENERADORCB_php = new cSIS_GENERADORCB_php();

// Page init
$SIS_GENERADORCB_php->Page_Init();

// Page main
$SIS_GENERADORCB_php->Page_Main();
...
<?php
$SIS_GENERADORCB_php->Page_Terminate();
?>
