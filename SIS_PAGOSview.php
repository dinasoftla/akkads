...
$SIS_PAGOS_view = NULL; // Initialize page object first

class cSIS_PAGOS_view extends cSIS_PAGOS {
	...
	// Page object name
	var $PageObjName = 'SIS_PAGOS_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["consecutivo"] <> "") {
				...
				$sReturnUrl = "SIS_PAGOSlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "SIS_PAGOSlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "SIS_PAGOSlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_SIS_PAGOS\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_SIS_PAGOS',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fSIS_PAGOSview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($SIS_PAGOS_view)) $SIS_PAGOS_view = new cSIS_PAGOS_view();

// Page init
$SIS_PAGOS_view->Page_Init();

// Page main
$SIS_PAGOS_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$SIS_PAGOS_view->Page_Render();
?>
<?php include_once "header.php" ?>
<?php if ($SIS_PAGOS->Export == "") { ?>
<script type="text/javascript">

// Form object
var CurrentPageID = EW_PAGE_ID = "view";
var CurrentForm = fSIS_PAGOSview = new ew_Form("fSIS_PAGOSview", "view");

// Form_CustomValidate event
fSIS_PAGOSview.Form_CustomValidate = 
...
fSIS_PAGOSview.ValidateRequired = true;
<?php } else { ?>
fSIS_PAGOSview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fSIS_PAGOSview.Lists["x_tipo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fSIS_PAGOSview.Lists["x_tipo"].Options = <?php echo json_encode($SIS_PAGOS->tipo->Options()) ?>;
fSIS_PAGOSview.Lists["x_codproveedor"] = {"LinkField":"x_codproveedor","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php } ?>
<?php $SIS_PAGOS_view->ExportOptions->Render("body") ?>
<?php
	foreach ($SIS_PAGOS_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($SIS_PAGOS->Export == "") { ?>
...
<?php } ?>
<?php $SIS_PAGOS_view->ShowPageHeader(); ?>
<?php
$SIS_PAGOS_view->ShowMessage();
?>
<form name="fSIS_PAGOSview" id="fSIS_PAGOSview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($SIS_PAGOS_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $SIS_PAGOS_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="SIS_PAGOS">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($SIS_PAGOS->consecutivo->Visible) { // consecutivo ?>
	<tr id="r_consecutivo">
		<td><span id="elh_SIS_PAGOS_consecutivo"><?php echo $SIS_PAGOS->consecutivo->FldCaption() ?></span></td>
...
<?php echo $SIS_PAGOS->consecutivo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_PAGOS->fecha->Visible) { // fecha ?>
	<tr id="r_fecha">
		<td><span id="elh_SIS_PAGOS_fecha"><?php echo $SIS_PAGOS->fecha->FldCaption() ?></span></td>
		<td data-name="fecha"<?php echo $SIS_PAGOS->fecha->CellAttributes() ?>>
<span id="el_SIS_PAGOS_fecha">
<span<?php echo $SIS_PAGOS->fecha->ViewAttributes() ?>>
<?php echo $SIS_PAGOS->fecha->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_PAGOS->tipo->Visible) { // tipo ?>
	<tr id="r_tipo">
		<td><span id="elh_SIS_PAGOS_tipo"><?php echo $SIS_PAGOS->tipo->FldCaption() ?></span></td>
...
<?php echo $SIS_PAGOS->tipo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_PAGOS->codproveedor->Visible) { // codproveedor ?>
	<tr id="r_codproveedor">
		<td><span id="elh_SIS_PAGOS_codproveedor"><?php echo $SIS_PAGOS->codproveedor->FldCaption() ?></span></td>
...
<?php echo $SIS_PAGOS->codproveedor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_PAGOS->factura->Visible) { // factura ?>
	<tr id="r_factura">
		<td><span id="elh_SIS_PAGOS_factura"><?php echo $SIS_PAGOS->factura->FldCaption() ?></span></td>
...
<?php echo $SIS_PAGOS->factura->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_PAGOS->descripcion->Visible) { // descripcion ?>
	<tr id="r_descripcion">
		<td><span id="elh_SIS_PAGOS_descripcion"><?php echo $SIS_PAGOS->descripcion->FldCaption() ?></span></td>
...
<?php echo $SIS_PAGOS->descripcion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_PAGOS->cantidad->Visible) { // cantidad ?>
	<tr id="r_cantidad">
		<td><span id="elh_SIS_PAGOS_cantidad"><?php echo $SIS_PAGOS->cantidad->FldCaption() ?></span></td>
...
<?php echo $SIS_PAGOS->cantidad->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_PAGOS->monto->Visible) { // monto ?>
	<tr id="r_monto">
		<td><span id="elh_SIS_PAGOS_monto"><?php echo $SIS_PAGOS->monto->FldCaption() ?></span></td>
...
<?php echo $SIS_PAGOS->monto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
