...
$VIW_SALIDA_INVENTARIO = NULL;

//
// Table class for VIW_SALIDA_INVENTARIO
//
class cVIW_SALIDA_INVENTARIO extends cTable {
	var $codarticulo;
	var $descripcion;
	var $canarticulo;
	var $canapartado;
	...
	function __construct() {
		...
		$this->TableVar = 'VIW_SALIDA_INVENTARIO';
		$this->TableName = 'VIW_SALIDA_INVENTARIO';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "[dbo].[VIW_SALIDA_INVENTARIO]";
		$this->DBID = 'DB';
		...
		// codarticulo
		$this->codarticulo = new cField('VIW_SALIDA_INVENTARIO', 'VIW_SALIDA_INVENTARIO', 'x_codarticulo', 'codarticulo', '[codarticulo]', '[codarticulo]', 200, -1, FALSE, '[codarticulo]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['codarticulo'] = &$this->codarticulo;

		// descripcion
		$this->descripcion = new cField('VIW_SALIDA_INVENTARIO', 'VIW_SALIDA_INVENTARIO', 'x_descripcion', 'descripcion', '[descripcion]', '[descripcion]', 200, -1, FALSE, '[descripcion]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['descripcion'] = &$this->descripcion;

		// canarticulo
		$this->canarticulo = new cField('VIW_SALIDA_INVENTARIO', 'VIW_SALIDA_INVENTARIO', 'x_canarticulo', 'canarticulo', '[canarticulo]', 'CAST([canarticulo] AS NVARCHAR)', 3, -1, FALSE, '[canarticulo]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->canarticulo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['canarticulo'] = &$this->canarticulo;

		// canapartado
		$this->canapartado = new cField('VIW_SALIDA_INVENTARIO', 'VIW_SALIDA_INVENTARIO', 'x_canapartado', 'canapartado', '[canapartado]', 'CAST([canapartado] AS NVARCHAR)', 3, -1, FALSE, '[canapartado]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->canapartado->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['canapartado'] = &$this->canapartado;

		// candisponible
		$this->candisponible = new cField('VIW_SALIDA_INVENTARIO', 'VIW_SALIDA_INVENTARIO', 'x_candisponible', 'candisponible', '[candisponible]', 'CAST([candisponible] AS NVARCHAR)', 3, -1, FALSE, '[candisponible]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->candisponible->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['candisponible'] = &$this->candisponible;

		// CantidadSaliente
		$this->CantidadSaliente = new cField('VIW_SALIDA_INVENTARIO', 'VIW_SALIDA_INVENTARIO', 'x_CantidadSaliente', 'CantidadSaliente', '[CantidadSaliente]', '[CantidadSaliente]', 200, -1, FALSE, '[CantidadSaliente]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "[dbo].[VIW_SALIDA_INVENTARIO]";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "VIW_SALIDA_INVENTARIOlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("VIW_SALIDA_INVENTARIOview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("VIW_SALIDA_INVENTARIOview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "VIW_SALIDA_INVENTARIOadd.php?" . $this->UrlParm($parm);
		else
			$url = "VIW_SALIDA_INVENTARIOadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("VIW_SALIDA_INVENTARIOedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("VIW_SALIDA_INVENTARIOadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("VIW_SALIDA_INVENTARIOdelete.php", $this->UrlParm());
	}
