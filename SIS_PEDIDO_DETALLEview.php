...
$SIS_PEDIDO_DETALLE_view = NULL; // Initialize page object first

class cSIS_PEDIDO_DETALLE_view extends cSIS_PEDIDO_DETALLE {
	...
	// Page object name
	var $PageObjName = 'SIS_PEDIDO_DETALLE_view';
	...
	function __construct() {
		...
		if (@$_GET["numdetpedido"] <> "") {
			$this->RecKey["numdetpedido"] = $_GET["numdetpedido"];
			$KeyUrl .= "&amp;numdetpedido=" . urlencode($this->RecKey["numdetpedido"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["numdetpedido"] <> "") {
			if ($gsExportFile <> "") $gsExportFile .= "_";
			$gsExportFile .= ew_StripSlashes($_GET["numdetpedido"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["numpedido"] <> "") {
				...
				$sReturnUrl = "SIS_PEDIDO_DETALLElist.php"; // Return to list
			}
			if (@$_GET["numdetpedido"] <> "") {
				$this->numdetpedido->setQueryStringValue($_GET["numdetpedido"]);
				$this->RecKey["numdetpedido"] = $this->numdetpedido->QueryStringValue;
			} elseif (@$_POST["numdetpedido"] <> "") {
				$this->numdetpedido->setFormValue($_POST["numdetpedido"]);
				$this->RecKey["numdetpedido"] = $this->numdetpedido->FormValue;
			} else {
				$sReturnUrl = "SIS_PEDIDO_DETALLElist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "SIS_PEDIDO_DETALLElist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "SIS_PEDIDO_DETALLElist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_SIS_PEDIDO_DETALLE\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_SIS_PEDIDO_DETALLE',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fSIS_PEDIDO_DETALLEview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($SIS_PEDIDO_DETALLE_view)) $SIS_PEDIDO_DETALLE_view = new cSIS_PEDIDO_DETALLE_view();

// Page init
$SIS_PEDIDO_DETALLE_view->Page_Init();

// Page main
$SIS_PEDIDO_DETALLE_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$SIS_PEDIDO_DETALLE_view->Page_Render();
?>
...
var CurrentForm = fSIS_PEDIDO_DETALLEview = new ew_Form("fSIS_PEDIDO_DETALLEview", "view");

// Form_CustomValidate event
fSIS_PEDIDO_DETALLEview.Form_CustomValidate = 
...
fSIS_PEDIDO_DETALLEview.ValidateRequired = true;
<?php } else { ?>
fSIS_PEDIDO_DETALLEview.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $SIS_PEDIDO_DETALLE_view->ExportOptions->Render("body") ?>
<?php
	foreach ($SIS_PEDIDO_DETALLE_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($SIS_PEDIDO_DETALLE->Export == "") { ?>
...
<?php } ?>
<?php $SIS_PEDIDO_DETALLE_view->ShowPageHeader(); ?>
<?php
$SIS_PEDIDO_DETALLE_view->ShowMessage();
?>
<form name="fSIS_PEDIDO_DETALLEview" id="fSIS_PEDIDO_DETALLEview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($SIS_PEDIDO_DETALLE_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $SIS_PEDIDO_DETALLE_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="SIS_PEDIDO_DETALLE">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($SIS_PEDIDO_DETALLE->numpedido->Visible) { // numpedido ?>
	<tr id="r_numpedido">
		<td><span id="elh_SIS_PEDIDO_DETALLE_numpedido"><?php echo $SIS_PEDIDO_DETALLE->numpedido->FldCaption() ?></span></td>
...
<?php echo $SIS_PEDIDO_DETALLE->numpedido->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_PEDIDO_DETALLE->numdetpedido->Visible) { // numdetpedido ?>
	<tr id="r_numdetpedido">
		<td><span id="elh_SIS_PEDIDO_DETALLE_numdetpedido"><?php echo $SIS_PEDIDO_DETALLE->numdetpedido->FldCaption() ?></span></td>
...
<?php echo $SIS_PEDIDO_DETALLE->numdetpedido->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_PEDIDO_DETALLE->codarticulo->Visible) { // codarticulo ?>
	<tr id="r_codarticulo">
		<td><span id="elh_SIS_PEDIDO_DETALLE_codarticulo"><?php echo $SIS_PEDIDO_DETALLE->codarticulo->FldCaption() ?></span></td>
...
<?php echo $SIS_PEDIDO_DETALLE->codarticulo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_PEDIDO_DETALLE->descripcion->Visible) { // descripcion ?>
	<tr id="r_descripcion">
		<td><span id="elh_SIS_PEDIDO_DETALLE_descripcion"><?php echo $SIS_PEDIDO_DETALLE->descripcion->FldCaption() ?></span></td>
		<td data-name="descripcion"<?php echo $SIS_PEDIDO_DETALLE->descripcion->CellAttributes() ?>>
<span id="el_SIS_PEDIDO_DETALLE_descripcion">
<span<?php echo $SIS_PEDIDO_DETALLE->descripcion->ViewAttributes() ?>>
<?php echo $SIS_PEDIDO_DETALLE->descripcion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_PEDIDO_DETALLE->cantidad->Visible) { // cantidad ?>
	<tr id="r_cantidad">
		<td><span id="elh_SIS_PEDIDO_DETALLE_cantidad"><?php echo $SIS_PEDIDO_DETALLE->cantidad->FldCaption() ?></span></td>
...
<?php echo $SIS_PEDIDO_DETALLE->cantidad->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_PEDIDO_DETALLE->preciounitario->Visible) { // preciounitario ?>
	<tr id="r_preciounitario">
		<td><span id="elh_SIS_PEDIDO_DETALLE_preciounitario"><?php echo $SIS_PEDIDO_DETALLE->preciounitario->FldCaption() ?></span></td>
		<td data-name="preciounitario"<?php echo $SIS_PEDIDO_DETALLE->preciounitario->CellAttributes() ?>>
<span id="el_SIS_PEDIDO_DETALLE_preciounitario">
<span<?php echo $SIS_PEDIDO_DETALLE->preciounitario->ViewAttributes() ?>>
<?php echo $SIS_PEDIDO_DETALLE->preciounitario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_PEDIDO_DETALLE->total->Visible) { // total ?>
	<tr id="r_total">
		<td><span id="elh_SIS_PEDIDO_DETALLE_total"><?php echo $SIS_PEDIDO_DETALLE->total->FldCaption() ?></span></td>
		<td data-name="total"<?php echo $SIS_PEDIDO_DETALLE->total->CellAttributes() ?>>
<span id="el_SIS_PEDIDO_DETALLE_total">
<span<?php echo $SIS_PEDIDO_DETALLE->total->ViewAttributes() ?>>
<?php echo $SIS_PEDIDO_DETALLE->total->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($SIS_PEDIDO_DETALLE->Export == "") { ?>
<script type="text/javascript">
fSIS_PEDIDO_DETALLEview.Init();
</script>
<?php } ?>
<?php
$SIS_PEDIDO_DETALLE_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($SIS_PEDIDO_DETALLE->Export == "") { ?>
...
<?php
$SIS_PEDIDO_DETALLE_view->Page_Terminate();
?>
