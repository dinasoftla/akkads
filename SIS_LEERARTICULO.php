...
$SIS_LEERARTICULO_php = NULL; // Initialize page object first

class cSIS_LEERARTICULO_php {
	...
	// Table name
	var $TableName = 'SIS_LEERARTICULO.php';

	// Page object name
	var $PageObjName = 'SIS_LEERARTICULO_php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'SIS_LEERARTICULO.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "SIS_LEERARTICULO_php", $url, "", "SIS_LEERARTICULO_php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($SIS_LEERARTICULO_php)) $SIS_LEERARTICULO_php = new cSIS_LEERARTICULO_php();

// Page init
$SIS_LEERARTICULO_php->Page_Init();

// Page main
$SIS_LEERARTICULO_php->Page_Main();
...
<?php
$SIS_LEERARTICULO_php->Page_Terminate();
?>
