...
//
// Table class for SIS_GASTOS
//
class cSIS_GASTOS extends cTable {
	var $consecutivo;
	var $fecha;
	var $tipo;
	var $codproveedor;
	...
	function __construct() {
		...
		$this->TableVar = 'SIS_GASTOS';
		$this->TableName = 'SIS_GASTOS';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "[dbo].[SIS_GASTOS]";
		$this->DBID = 'DB';
		...
		// consecutivo
		$this->consecutivo = new cField('SIS_GASTOS', 'SIS_GASTOS', 'x_consecutivo', 'consecutivo', '[consecutivo]', 'CAST([consecutivo] AS NVARCHAR)', 3, -1, FALSE, '[consecutivo]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->consecutivo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['consecutivo'] = &$this->consecutivo;

		// fecha
		$this->fecha = new cField('SIS_GASTOS', 'SIS_GASTOS', 'x_fecha', 'fecha', '[fecha]', '[fecha]', 202, -1, FALSE, '[fecha]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['fecha'] = &$this->fecha;

		// tipo
		$this->tipo = new cField('SIS_GASTOS', 'SIS_GASTOS', 'x_tipo', 'tipo', '[tipo]', '[tipo]', 200, -1, FALSE, '[tipo]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->tipo->OptionCount = 2;
		$this->fields['tipo'] = &$this->tipo;

		// codproveedor
		$this->codproveedor = new cField('SIS_GASTOS', 'SIS_GASTOS', 'x_codproveedor', 'codproveedor', '[codproveedor]', 'CAST([codproveedor] AS NVARCHAR)', 3, -1, FALSE, '[codproveedor]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->codproveedor->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['codproveedor'] = &$this->codproveedor;

		// factura
		$this->factura = new cField('SIS_GASTOS', 'SIS_GASTOS', 'x_factura', 'factura', '[factura]', 'CAST([factura] AS NVARCHAR)', 3, -1, FALSE, '[factura]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->factura->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['factura'] = &$this->factura;

		// descripcion
		$this->descripcion = new cField('SIS_GASTOS', 'SIS_GASTOS', 'x_descripcion', 'descripcion', '[descripcion]', '[descripcion]', 200, -1, FALSE, '[descripcion]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['descripcion'] = &$this->descripcion;

		// cantidad
		$this->cantidad = new cField('SIS_GASTOS', 'SIS_GASTOS', 'x_cantidad', 'cantidad', '[cantidad]', 'CAST([cantidad] AS NVARCHAR)', 3, -1, FALSE, '[cantidad]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cantidad->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cantidad'] = &$this->cantidad;

		// monto
		$this->monto = new cField('SIS_GASTOS', 'SIS_GASTOS', 'x_monto', 'monto', '[monto]', 'CAST([monto] AS NVARCHAR)', 5, -1, FALSE, '[monto]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "[dbo].[SIS_GASTOS]";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("SIS_GASTOSview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("SIS_GASTOSview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "SIS_GASTOSadd.php?" . $this->UrlParm($parm);
		else
			$url = "SIS_GASTOSadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("SIS_GASTOSedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("SIS_GASTOSadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("SIS_GASTOSdelete.php", $this->UrlParm());
	}
