...
$Chart->ID = "VIW_HISTORIAL_ARTICULOS_Ventas"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_VIW_HISTORIAL_ARTICULOS_Ventas", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_VIW_HISTORIAL_ARTICULOS_Ventas_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
