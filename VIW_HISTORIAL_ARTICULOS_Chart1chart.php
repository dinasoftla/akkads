...
$Chart->ID = "VIW_HISTORIAL_ARTICULOS_Chart1"; // Chart ID
...
<?php
	...
	ewr_SortMultiChartData($Chart->Data, 0, "");
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_VIW_HISTORIAL_ARTICULOS_Chart1", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_VIW_HISTORIAL_ARTICULOS_Chart1_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
