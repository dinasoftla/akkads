...
class cSISTEMA_db extends cDbHelper {
	...
	function &Connect($info = NULL) {
		...
		if (!$info) {
			$info = array("connectionstring" => "Provider=SQLOLEDB;Persist Security Info=False;Data Source=DESKTOP-FN7FSTU\\SQLEXPRESS;Initial Catalog=SISTEMA;User Id=sa;Password=Sistema1032"); // ADO connection
		}
		if ($this->Debug)
