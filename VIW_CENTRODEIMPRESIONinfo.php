...
$VIW_CENTRODEIMPRESION = NULL;

//
// Table class for VIW_CENTRODEIMPRESION
//
class cVIW_CENTRODEIMPRESION extends cTable {
	var $codarticulo;
	var $descripcion;
	var $foto;
	var $codlinea;
	...
	function __construct() {
		...
		$this->TableVar = 'VIW_CENTRODEIMPRESION';
		$this->TableName = 'VIW_CENTRODEIMPRESION';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "[dbo].[VIW_CENTRODEIMPRESION]";
		$this->DBID = 'DB';
		...
		// codarticulo
		$this->codarticulo = new cField('VIW_CENTRODEIMPRESION', 'VIW_CENTRODEIMPRESION', 'x_codarticulo', 'codarticulo', '[codarticulo]', '[codarticulo]', 200, -1, FALSE, '[codarticulo]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->codarticulo->OptionCount = 2;
		$this->fields['codarticulo'] = &$this->codarticulo;

		// descripcion
		$this->descripcion = new cField('VIW_CENTRODEIMPRESION', 'VIW_CENTRODEIMPRESION', 'x_descripcion', 'descripcion', '[descripcion]', '[descripcion]', 200, -1, FALSE, '[descripcion]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['descripcion'] = &$this->descripcion;

		// foto
		$this->foto = new cField('VIW_CENTRODEIMPRESION', 'VIW_CENTRODEIMPRESION', 'x_foto', 'foto', '[foto]', '[foto]', 200, -1, FALSE, '[foto]', FALSE, FALSE, FALSE, 'IMAGE', 'TEXT');
		$this->fields['foto'] = &$this->foto;

		// codlinea
		$this->codlinea = new cField('VIW_CENTRODEIMPRESION', 'VIW_CENTRODEIMPRESION', 'x_codlinea', 'codlinea', '[codlinea]', 'CAST([codlinea] AS NVARCHAR)', 3, -1, FALSE, '[codlinea]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->codlinea->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['codlinea'] = &$this->codlinea;

		// Cantidad
		$this->Cantidad = new cField('VIW_CENTRODEIMPRESION', 'VIW_CENTRODEIMPRESION', 'x_Cantidad', 'Cantidad', '[Cantidad]', '[Cantidad]', 200, -1, FALSE, '[Cantidad]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "[dbo].[VIW_CENTRODEIMPRESION]";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "VIW_CENTRODEIMPRESIONlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("VIW_CENTRODEIMPRESIONview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("VIW_CENTRODEIMPRESIONview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "VIW_CENTRODEIMPRESIONadd.php?" . $this->UrlParm($parm);
		else
			$url = "VIW_CENTRODEIMPRESIONadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("VIW_CENTRODEIMPRESIONedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("VIW_CENTRODEIMPRESIONadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("VIW_CENTRODEIMPRESIONdelete.php", $this->UrlParm());
	}
