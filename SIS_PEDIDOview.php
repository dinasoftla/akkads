...
<div id="ct_SIS_PEDIDO_view"><!-- Header image -->
...
<?php
	...
	if ($cantidad == 0)
	{
		$LINKURL = "SIS_GENERAR_FACTURA.php?showdetail=&amp;numpedido=" . $numpedido;
...
<?php if ($SIS_PEDIDO->estado->Visible) { // estado ?>
	<tr id="r_estado">
		<td><span id="elh_SIS_PEDIDO_estado"><script id="tpc_SIS_PEDIDO_estado" class="SIS_PEDIDOview" type="text/html"><span><?php echo $SIS_PEDIDO->estado->FldCaption() ?></span></script></span></td>
		<td data-name="estado"<?php echo $SIS_PEDIDO->estado->CellAttributes() ?>>
<script id="tpx_SIS_PEDIDO_estado" class="SIS_PEDIDOview" type="text/html">
<span id="el_SIS_PEDIDO_estado">
<span<?php echo $SIS_PEDIDO->estado->ViewAttributes() ?>>
<?php echo $SIS_PEDIDO->estado->ViewValue ?></span>
</span>
</script>
</td>
	</tr>
...
<?php if ($SIS_PEDIDO->transporte->Visible) { // transporte ?>
	<tr id="r_transporte">
		<td><span id="elh_SIS_PEDIDO_transporte"><script id="tpc_SIS_PEDIDO_transporte" class="SIS_PEDIDOview" type="text/html"><span><?php echo $SIS_PEDIDO->transporte->FldCaption() ?></span></script></span></td>
		<td data-name="transporte"<?php echo $SIS_PEDIDO->transporte->CellAttributes() ?>>
<script id="tpx_SIS_PEDIDO_transporte" class="SIS_PEDIDOview" type="text/html">
<span id="el_SIS_PEDIDO_transporte">
<span<?php echo $SIS_PEDIDO->transporte->ViewAttributes() ?>>
<?php echo $SIS_PEDIDO->transporte->ViewValue ?></span>
</span>
</script>
</td>
	</tr>
