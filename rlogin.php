	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			...
			<div id="frptlogin_options" class="collapse">
					...
					<div class="radio ewRadio">
					<label for="type3"><input type="radio" name="type" id="type3" value=""<?php if ($rptlogin->LoginType == "") { ?> checked="checked"<?php } ?>><?php echo $ReportLanguage->Phrase("AlwaysAsk") ?></label>
					</div>
		</div>
	</div>
	</div>
