...
$VIW_DETALLEPEDIDO = NULL;

//
// Table class for VIW_DETALLEPEDIDO
//
class cVIW_DETALLEPEDIDO extends cTable {
	var $codarticulo;
	var $descripcion;
	var $cantidad;
	var $precio;
	...
	function __construct() {
		...
		$this->TableVar = 'VIW_DETALLEPEDIDO';
		$this->TableName = 'VIW_DETALLEPEDIDO';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "[dbo].[VIW_DETALLEPEDIDO]";
		$this->DBID = 'DB';
		...
		// codarticulo
		$this->codarticulo = new cField('VIW_DETALLEPEDIDO', 'VIW_DETALLEPEDIDO', 'x_codarticulo', 'codarticulo', '[codarticulo]', '[codarticulo]', 200, -1, FALSE, '[codarticulo]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['codarticulo'] = &$this->codarticulo;

		// descripcion
		$this->descripcion = new cField('VIW_DETALLEPEDIDO', 'VIW_DETALLEPEDIDO', 'x_descripcion', 'descripcion', '[descripcion]', '[descripcion]', 200, -1, FALSE, '[descripcion]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['descripcion'] = &$this->descripcion;

		// cantidad
		$this->cantidad = new cField('VIW_DETALLEPEDIDO', 'VIW_DETALLEPEDIDO', 'x_cantidad', 'cantidad', '[cantidad]', 'CAST([cantidad] AS NVARCHAR)', 3, -1, FALSE, '[cantidad]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cantidad->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cantidad'] = &$this->cantidad;

		// precio
		$this->precio = new cField('VIW_DETALLEPEDIDO', 'VIW_DETALLEPEDIDO', 'x_precio', 'precio', '[precio]', 'CAST([precio] AS NVARCHAR)', 131, -1, FALSE, '[precio]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->precio->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['precio'] = &$this->precio;

		// foto
		$this->foto = new cField('VIW_DETALLEPEDIDO', 'VIW_DETALLEPEDIDO', 'x_foto', 'foto', '[foto]', '[foto]', 200, -1, FALSE, '[foto]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['foto'] = &$this->foto;

		// garantia
		$this->garantia = new cField('VIW_DETALLEPEDIDO', 'VIW_DETALLEPEDIDO', 'x_garantia', 'garantia', '[garantia]', '[garantia]', 200, -1, FALSE, '[garantia]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['garantia'] = &$this->garantia;

		// codusuario
		$this->codusuario = new cField('VIW_DETALLEPEDIDO', 'VIW_DETALLEPEDIDO', 'x_codusuario', 'codusuario', '[codusuario]', 'CAST([codusuario] AS NVARCHAR)', 3, -1, FALSE, '[codusuario]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "[dbo].[VIW_DETALLEPEDIDO]";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "VIW_DETALLEPEDIDOlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("VIW_DETALLEPEDIDOview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("VIW_DETALLEPEDIDOview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "VIW_DETALLEPEDIDOadd.php?" . $this->UrlParm($parm);
		else
			$url = "VIW_DETALLEPEDIDOadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("VIW_DETALLEPEDIDOedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("VIW_DETALLEPEDIDOadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("VIW_DETALLEPEDIDOdelete.php", $this->UrlParm());
	}
