...
$SIS_INGRESOS_edit = NULL; // Initialize page object first

class cSIS_INGRESOS_edit extends cSIS_INGRESOS {
	...
	// Page object name
	var $PageObjName = 'SIS_INGRESOS_edit';
	...
	function Page_Main() {
		...
		if ($this->consecutivo->CurrentValue == "")
			$this->Page_Terminate("SIS_INGRESOSlist.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// codcliente
			$this->codcliente->SetDbValueDef($rsnew, $this->codcliente->CurrentValue, 0, $this->codcliente->ReadOnly);
...
// Create page object
if (!isset($SIS_INGRESOS_edit)) $SIS_INGRESOS_edit = new cSIS_INGRESOS_edit();

// Page init
$SIS_INGRESOS_edit->Page_Init();

// Page main
$SIS_INGRESOS_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$SIS_INGRESOS_edit->Page_Render();
?>
...
var CurrentForm = fSIS_INGRESOSedit = new ew_Form("fSIS_INGRESOSedit", "edit");

// Validate form
fSIS_INGRESOSedit.Validate = function() {
...
fSIS_INGRESOSedit.Form_CustomValidate = 
...
fSIS_INGRESOSedit.ValidateRequired = true;
<?php } else { ?>
fSIS_INGRESOSedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fSIS_INGRESOSedit.Lists["x_tipo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fSIS_INGRESOSedit.Lists["x_tipo"].Options = <?php echo json_encode($SIS_INGRESOS->tipo->Options()) ?>;
fSIS_INGRESOSedit.Lists["x_codcliente"] = {"LinkField":"x_codcliente","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php $SIS_INGRESOS_edit->ShowPageHeader(); ?>
<?php
$SIS_INGRESOS_edit->ShowMessage();
?>
<form name="fSIS_INGRESOSedit" id="fSIS_INGRESOSedit" class="<?php echo $SIS_INGRESOS_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($SIS_INGRESOS_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $SIS_INGRESOS_edit->Token ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $SIS_INGRESOS->consecutivo->EditValue ?></p></span>
</span>
<input type="hidden" data-table="SIS_INGRESOS" data-field="x_consecutivo" name="x_consecutivo" id="x_consecutivo" value="<?php echo ew_HtmlEncode($SIS_INGRESOS->consecutivo->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $SIS_INGRESOS_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fSIS_INGRESOSedit.Init();
</script>
<?php
$SIS_INGRESOS_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$SIS_INGRESOS_edit->Page_Terminate();
?>
