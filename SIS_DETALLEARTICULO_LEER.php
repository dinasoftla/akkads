...
$SIS_DETALLEARTICULO_LEER_php = NULL; // Initialize page object first

class cSIS_DETALLEARTICULO_LEER_php {
	...
	// Table name
	var $TableName = 'SIS_DETALLEARTICULO_LEER.php';

	// Page object name
	var $PageObjName = 'SIS_DETALLEARTICULO_LEER_php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'SIS_DETALLEARTICULO_LEER.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "SIS_DETALLEARTICULO_LEER_php", $url, "", "SIS_DETALLEARTICULO_LEER_php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($SIS_DETALLEARTICULO_LEER_php)) $SIS_DETALLEARTICULO_LEER_php = new cSIS_DETALLEARTICULO_LEER_php();

// Page init
$SIS_DETALLEARTICULO_LEER_php->Page_Init();

// Page main
$SIS_DETALLEARTICULO_LEER_php->Page_Main();
...
<?php
 			    echo "<form name='form' action='SIS_LEERUBICACION.php'>";
	   			echo "<div style='text-align:center'>";
	   				   echo '<center>
	   					...
	   					echo '<input autocomplete="off" onfocusout="txtlostfocus(this)" onfocusin="txtgetfocus(this)"
				    			type="password" name="txtarticulo" id="txtarticulo" value="" size="30"	maxlength="20"
				    			class="form-control" onchange = "document.form.submit();" style= "background-color:#BDBDBD; color:#BDBDBD;">';
				        echo '&nbsp';
				echo "</div>";
				echo "</form>";
...
<?php
$SIS_DETALLEARTICULO_LEER_php->Page_Terminate();
?>
