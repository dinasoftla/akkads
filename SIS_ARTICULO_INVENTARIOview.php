...
$SIS_ARTICULO_INVENTARIO_view = NULL; // Initialize page object first

class cSIS_ARTICULO_INVENTARIO_view extends cSIS_ARTICULO_INVENTARIO {
	...
	// Page object name
	var $PageObjName = 'SIS_ARTICULO_INVENTARIO_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["codarticulo"] <> "") {
				...
				$sReturnUrl = "SIS_ARTICULO_INVENTARIOlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "SIS_ARTICULO_INVENTARIOlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "SIS_ARTICULO_INVENTARIOlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_SIS_ARTICULO_INVENTARIO\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_SIS_ARTICULO_INVENTARIO',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fSIS_ARTICULO_INVENTARIOview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($SIS_ARTICULO_INVENTARIO_view)) $SIS_ARTICULO_INVENTARIO_view = new cSIS_ARTICULO_INVENTARIO_view();

// Page init
$SIS_ARTICULO_INVENTARIO_view->Page_Init();

// Page main
$SIS_ARTICULO_INVENTARIO_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$SIS_ARTICULO_INVENTARIO_view->Page_Render();
?>
<?php include_once "header.php" ?>
<?php if ($SIS_ARTICULO_INVENTARIO->Export == "") { ?>
<script type="text/javascript">

// Form object
var CurrentPageID = EW_PAGE_ID = "view";
var CurrentForm = fSIS_ARTICULO_INVENTARIOview = new ew_Form("fSIS_ARTICULO_INVENTARIOview", "view");

// Form_CustomValidate event
fSIS_ARTICULO_INVENTARIOview.Form_CustomValidate = 
...
fSIS_ARTICULO_INVENTARIOview.ValidateRequired = true;
<?php } else { ?>
fSIS_ARTICULO_INVENTARIOview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fSIS_ARTICULO_INVENTARIOview.Lists["x_codarticulo"] = {"LinkField":"x_codarticulo","Ajax":true,"AutoFill":false,"DisplayFields":["x_codarticulo","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fSIS_ARTICULO_INVENTARIOview.Lists["x_codubicacion"] = {"LinkField":"x_codubicacion","Ajax":true,"AutoFill":false,"DisplayFields":["x_ubicacion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php } ?>
<?php $SIS_ARTICULO_INVENTARIO_view->ExportOptions->Render("body") ?>
<?php
	foreach ($SIS_ARTICULO_INVENTARIO_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($SIS_ARTICULO_INVENTARIO->Export == "") { ?>
...
<?php } ?>
<?php $SIS_ARTICULO_INVENTARIO_view->ShowPageHeader(); ?>
<?php
$SIS_ARTICULO_INVENTARIO_view->ShowMessage();
?>
<form name="fSIS_ARTICULO_INVENTARIOview" id="fSIS_ARTICULO_INVENTARIOview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($SIS_ARTICULO_INVENTARIO_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $SIS_ARTICULO_INVENTARIO_view->Token ?>">
<?php } ?>
...
<?php if ($SIS_ARTICULO_INVENTARIO->codarticulo->Visible) { // codarticulo ?>
	<tr id="r_codarticulo">
		<td><span id="elh_SIS_ARTICULO_INVENTARIO_codarticulo"><?php echo $SIS_ARTICULO_INVENTARIO->codarticulo->FldCaption() ?></span></td>
...
<?php echo $SIS_ARTICULO_INVENTARIO->codarticulo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_ARTICULO_INVENTARIO->canarticulo->Visible) { // canarticulo ?>
	<tr id="r_canarticulo">
		<td><span id="elh_SIS_ARTICULO_INVENTARIO_canarticulo"><?php echo $SIS_ARTICULO_INVENTARIO->canarticulo->FldCaption() ?></span></td>
...
<?php echo $SIS_ARTICULO_INVENTARIO->canarticulo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_ARTICULO_INVENTARIO->candisponible->Visible) { // candisponible ?>
	<tr id="r_candisponible">
		<td><span id="elh_SIS_ARTICULO_INVENTARIO_candisponible"><?php echo $SIS_ARTICULO_INVENTARIO->candisponible->FldCaption() ?></span></td>
...
<?php echo $SIS_ARTICULO_INVENTARIO->candisponible->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_ARTICULO_INVENTARIO->canapartado->Visible) { // canapartado ?>
	<tr id="r_canapartado">
		<td><span id="elh_SIS_ARTICULO_INVENTARIO_canapartado"><?php echo $SIS_ARTICULO_INVENTARIO->canapartado->FldCaption() ?></span></td>
...
<?php echo $SIS_ARTICULO_INVENTARIO->canapartado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_ARTICULO_INVENTARIO->fecultimamod->Visible) { // fecultimamod ?>
	<tr id="r_fecultimamod">
		<td><span id="elh_SIS_ARTICULO_INVENTARIO_fecultimamod"><?php echo $SIS_ARTICULO_INVENTARIO->fecultimamod->FldCaption() ?></span></td>
		<td data-name="fecultimamod"<?php echo $SIS_ARTICULO_INVENTARIO->fecultimamod->CellAttributes() ?>>
<span id="el_SIS_ARTICULO_INVENTARIO_fecultimamod">
<span<?php echo $SIS_ARTICULO_INVENTARIO->fecultimamod->ViewAttributes() ?>>
<?php echo $SIS_ARTICULO_INVENTARIO->fecultimamod->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_ARTICULO_INVENTARIO->usuarioultimamod->Visible) { // usuarioultimamod ?>
	<tr id="r_usuarioultimamod">
		<td><span id="elh_SIS_ARTICULO_INVENTARIO_usuarioultimamod"><?php echo $SIS_ARTICULO_INVENTARIO->usuarioultimamod->FldCaption() ?></span></td>
		<td data-name="usuarioultimamod"<?php echo $SIS_ARTICULO_INVENTARIO->usuarioultimamod->CellAttributes() ?>>
<span id="el_SIS_ARTICULO_INVENTARIO_usuarioultimamod">
<span<?php echo $SIS_ARTICULO_INVENTARIO->usuarioultimamod->ViewAttributes() ?>>
<?php echo $SIS_ARTICULO_INVENTARIO->usuarioultimamod->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($SIS_ARTICULO_INVENTARIO->codubicacion->Visible) { // codubicacion ?>
	<tr id="r_codubicacion">
		<td><span id="elh_SIS_ARTICULO_INVENTARIO_codubicacion"><?php echo $SIS_ARTICULO_INVENTARIO->codubicacion->FldCaption() ?></span></td>
...
<?php echo $SIS_ARTICULO_INVENTARIO->codubicacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($SIS_ARTICULO_INVENTARIO->Export == "") { ?>
<script type="text/javascript">
fSIS_ARTICULO_INVENTARIOview.Init();
</script>
<?php } ?>
<?php
$SIS_ARTICULO_INVENTARIO_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($SIS_ARTICULO_INVENTARIO->Export == "") { ?>
...
<?php
$SIS_ARTICULO_INVENTARIO_view->Page_Terminate();
?>
