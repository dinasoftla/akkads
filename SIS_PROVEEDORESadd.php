...
$SIS_PROVEEDORES_add = NULL; // Initialize page object first

class cSIS_PROVEEDORES_add extends cSIS_PROVEEDORES {
	...
	// Page object name
	var $PageObjName = 'SIS_PROVEEDORES_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["codproveedor"] != "") {
				...
				$this->setKey("codproveedor", $this->codproveedor->CurrentValue); // Set up key
			} else {
				$this->setKey("codproveedor", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "SIS_PROVEEDORESview.php")
...
// Create page object
if (!isset($SIS_PROVEEDORES_add)) $SIS_PROVEEDORES_add = new cSIS_PROVEEDORES_add();

// Page init
$SIS_PROVEEDORES_add->Page_Init();

// Page main
$SIS_PROVEEDORES_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$SIS_PROVEEDORES_add->Page_Render();
?>
...
var CurrentForm = fSIS_PROVEEDORESadd = new ew_Form("fSIS_PROVEEDORESadd", "add");

// Validate form
fSIS_PROVEEDORESadd.Validate = function() {
...
fSIS_PROVEEDORESadd.Form_CustomValidate = 
...
fSIS_PROVEEDORESadd.ValidateRequired = true;
<?php } else { ?>
fSIS_PROVEEDORESadd.ValidateRequired = false; 
<?php } ?>
...
<?php $SIS_PROVEEDORES_add->ShowPageHeader(); ?>
<?php
$SIS_PROVEEDORES_add->ShowMessage();
?>
<form name="fSIS_PROVEEDORESadd" id="fSIS_PROVEEDORESadd" class="<?php echo $SIS_PROVEEDORES_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($SIS_PROVEEDORES_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $SIS_PROVEEDORES_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $SIS_PROVEEDORES_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
fSIS_PROVEEDORESadd.Init();
</script>
<?php
$SIS_PROVEEDORES_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$SIS_PROVEEDORES_add->Page_Terminate();
?>
